...
def train(config):
    ...
    writer1.writerow(['epoch', 'training_loss', 'training_NMSE', 'testing_loss', 'testing_NMSE'])
    f2 = open('results/' + experiment_name + '2.csv', 'w')
    writer2 = csv.writer(f2)
    writer2.writerow(['epoch', 'training_loss', 'training_NMSE', 'testing_loss', 'testing_NMSE'])
    ...
    for epoch in range(epochs):
        ...
        writer1.writerow([epoch, train_loss, train_avg_nmse, test_loss, avg_nmse])
    ...
    for epoch in range(epochs):
        ...
        test_loss = (sum_loss / (i + 1))
        print("avg_nmse : ", avg_nmse)
        writer2.writerow([epoch, train_loss, train_avg_nmse, test_loss, avg_nmse])
